...
var removeDuplicates = function (nums) {
  const numsFiltered = nums
    .sort()
    .reduce((acummulator, currentValue, index) => {
      if (index > 0 && currentValue === nums[index - 1]) {
        return acummulator;
      }
...
console.assert(
  ...
  "%o",
  { return: removeDuplicates([1, 1, 2]), errorMsg: "Is not equal" }
);
console.assert(
